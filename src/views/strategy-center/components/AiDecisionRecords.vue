      ...
      <a-timeline v-else>
        <a-timeline-item v-for="row in rows" :key="row.decision_uid" :color="decisionColor(row)">
          <div class="ai-decision-record">
            ...
            <a-collapse v-if="decisionChecks(row).length" :bordered="false" class="ai-decision-record__details">
              <a-collapse-panel key="details" :header="$t('aiDecisionFilter.viewConfidenceDetails')">
...
.ai-decision-record__details { margin-top: 8px; background: transparent; }
.ai-decision-record__details /deep/ .ant-collapse-header { padding: 7px 0 5px 20px; color: #526172; font-size: 12px; }
.ai-decision-record__details /deep/ .ant-collapse-content-box { padding: 4px 0 0; }
...
.is-compact .ai-decision-record { padding: 10px 12px; }
...
.theme-dark .ai-decision-record__details /deep/ .ant-collapse-header,
